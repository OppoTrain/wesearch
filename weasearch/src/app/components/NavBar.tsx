...
const NavBar: React.FC = () => {
  ...
  return (
    <SessionProvider>
      <nav className="bg-gray-900 text-gray-100 w-full z-20 shadow-lg">
        <div className="w-full flex items-center justify-between px-6 py-8">
          ...
          <div className="hidden md:flex items-center space-x-6 ml-auto">
            ...
            <div className="relative">
              ...
              <ul
                className={`absolute mt-2 bg-gray-800 rounded-lg shadow-md text-sm text-gray-100 ${dropdownOpen ? "block" : "hidden"}`}
                style={{ zIndex: 50 }} // Ensure dropdown appears above other content
              >
